...
def main():
    ...
    axes[0].plot(tlist, x_redfield, color='#008000', label= f"Redfield")#{round(np.real(xmean),2)
    axes[0].plot(tlist, x_hamiltonian7, color='#000080', label= f"Hamiltonian 7")
    axes[0].plot(tlist, x_rates, color='#800000', label= f"Rates")
    ...
    axes[1].plot(tlist, z_redfield, color='#008000', label= f"Redfield")
    axes[1].plot(tlist, z_hamiltonian7, color='#000080', label= f"Hamiltonian 7")#{round(np.real(zmean),2)}
    axes[1].plot(tlist, z_rates, color='#800000', label= f"Rates")
