...
def sweep_eff_coupling():
    ...
    for i, eff_coupling in enumerate(eff_coupling_values):
        ...
        try:
            ...
            fig, axes = plot_dynamics_comparison(tlist, dynamics_dict, params_text)
